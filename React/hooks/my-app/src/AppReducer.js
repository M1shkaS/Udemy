...
const Slider = ({ initial }) => {
   ...
   // Принимает 3 аргумента; arg1 - функция reducer, arg2 - начальное состояние, arg3 - аргумент для создания ленивого состояния
   const [autoplay, dispatch] = useReducer(reducer, initial, init);
   // arg1 - функция reducer, отвечает за модификацию состояния, не вызов изменения как делает dispatch, а именно модификацию 
